Contributing to Cryptexblue (CXB) Core
============================

The Cryptexblue (CXB) Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Cryptexblue (CXB) Core
...
Before you start contributing, familiarize yourself with the Cryptexblue (CXB) Core build
system and tests. Refer to the documentation in the repository on how to build
Cryptexblue (CXB) Core and how to run the unit tests, functional tests, and fuzz tests.
...
Most communication about Cryptexblue (CXB) Core development happens on IRC, in the
`#Cryptexblue (CXB)-core-dev` channel on Freenode. The easiest way to participate on IRC is
with the web client, [webchat.freenode.net](https://webchat.freenode.net/). Chat
history logs can be found
on [http://www.erisian.com.au/Cryptexblue(CXB)-core-dev/](http://www.erisian.com.au/Cryptexblue(CXB)-core-dev/)
and [http://gnusha.org/Cryptexblue(CXB)-core-dev/](http://gnusha.org/Cryptexblue(CXB)-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://lists.linuxfoundation.org/mailman/listinfo/Cryptexblue(CXB)-dev)
...
For GUI-related issues or pull requests, the https://github.com/Cryptexblue/gui repository should be used.
For all other issues and pull requests, the https://github.com/Cryptexblue/Cryptexblue node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to Cryptexblue (CXB)-qt
...
fork of Cryptexblue (CXB) Core copies the merge. Instead, make any username mentions in a
subsequent comment to the PR.

### Translation changes

Note that translations should not be submitted as pull requests. Please see
[Translation Process](https://github.com/Cryptexblue (CXB)/Cryptexblue (CXB)/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Cryptexblue (CXB) Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Cryptexblue (CXB)
Network Protocol consensus changes.

Whether a pull request is merged into Cryptexblue (CXB) Core rests with the project merge
...
Patches that change Cryptexblue (CXB) consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cryptexblue (CXB) consensus, it must have been
...
https://github.com/Cryptexblue/Cryptexblue-maintainer-tools#backport).

Release Policy
--------------

The project leader is the release manager for each Cryptexblue (CXB) Core release.
